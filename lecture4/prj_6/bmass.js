...
var BMI=
{
    ...
    input_values: function()
    {
        ...
        //BMI.calc_BMI();// this should later be added to a button tag in the html.
    },
...
// call the method that will collect the needed values when the page loads
window.onload = BMI.input_values;
